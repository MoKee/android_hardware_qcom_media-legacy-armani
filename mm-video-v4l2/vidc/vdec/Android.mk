...
libmm-vdec-inc          += hardware/qcom/media-legacy-armani/mm-core/inc
#DRM include - Interface which loads the DRM library
libmm-vdec-inc	        += $(OMX_VIDEO_PATH)/DivxDrmDecrypt/inc
libmm-vdec-inc          += hardware/qcom/display-legacy-armani/libgralloc
libmm-vdec-inc          += frameworks/native/include/media/openmax
libmm-vdec-inc          += frameworks/native/include/media/hardware
libmm-vdec-inc          += $(vdec-inc)
libmm-vdec-inc          += hardware/qcom/display-legacy-armani/libqdutils
libmm-vdec-inc      += hardware/qcom/media-legacy-armani/libc2dcolorconvert
libmm-vdec-inc      += hardware/qcom/display-legacy-armani/libcopybit
libmm-vdec-inc      += frameworks/av/include/media/stagefright
libmm-vdec-inc      += $(TARGET_OUT_HEADERS)/mm-video/SwVdec
libmm-vdec-inc      += $(TARGET_OUT_HEADERS)/qcom/display-legacy-armani/
...
libmm-vdec-inc          += hardware/qcom/display-legacy-armani/libhwcomposer
...
mm-vdec-test-inc    := hardware/qcom/media-legacy-armani/mm-core/inc
...
mm-vdec-drv-test-inc    := hardware/qcom/media-legacy-armani/mm-core/inc
