...
libmm-venc-inc      += hardware/qcom/media-legacy-armani/mm-core/inc
libmm-venc-inc      += hardware/qcom/media-legacy-armani/libstagefrighthw
libmm-venc-inc      += hardware/qcom/display-legacy-armani/libgralloc
libmm-venc-inc      += frameworks/native/include/media/hardware
libmm-venc-inc      += frameworks/native/include/media/openmax
libmm-venc-inc      += hardware/qcom/media-legacy-armani/libc2dcolorconvert
libmm-venc-inc      += hardware/qcom/display-legacy-armani/libcopybit
libmm-venc-inc      += frameworks/av/include/media/stagefright
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/qcom/display-legacy-armani/
...
mm-venc-test720p-inc            += hardware/qcom/media-legacy-armani/mm-core/inc
mm-venc-test720p-inc            += hardware/qcom/display-legacy-armani/libgralloc
...
venc-test-inc                   += hardware/qcom/display-legacy-armani/libgralloc
venc-test-inc                   += $(venc-inc)

LOCAL_MODULE                    := mm-video-encdrv-test
LOCAL_MODULE_TAGS               := optional
LOCAL_C_INCLUDES                := $(venc-test-inc)
LOCAL_C_INCLUDES                += hardware/qcom/media-legacy-armani/mm-core/inc
